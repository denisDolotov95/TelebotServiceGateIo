...
class Spot:
    ...
    def currency_pair(self, *args, **kwargs) -> CurrencyPair:
        ...
        api_response = self.spot_api_instance.get_currency_pair(
            *args, **kwargs
        )
    ...
    def cancel_orders(self, *args, **kwargs) -> list:
        ...
        """
        api_response = self.spot_api_instance.cancel_orders(
            *args, **kwargs
        )
        cancel_orders = list()
    ...
    def list_orders(self, *args, **kwargs) -> list[Order]:
        ...
        Returns:
            list[Order]: _description_
        """
        api_response = self.spot_api_instance.list_orders(
            *args, **kwargs
        )
        list_orders = list()
        for data in api_response.get() if kwargs.get("async_req") else api_response:
    ...
    def list_tickers(self, *args, **kwargs) -> list[Ticker]:
        ...
        """
        api_response = self.spot_api_instance.list_tickers(
            *args, **kwargs
        )
        tickers = list()
        for data in api_response.get() if kwargs.get("async_req") else api_response:
    ...
    def list_currency_pairs(self, *args, **kwargs) -> list[CurrencyPair]:
        ...
        """
        api_response = self.spot_api_instance.list_currency_pairs(
            *args, **kwargs
        )
        pairs = list()
        for data in api_response.get() if kwargs.get("async_req") else api_response:
    ...
    def list_spot_account_book(self, *args, **kwargs) -> list[AccountBook]:
        ...
        api_response = self.spot_api_instance.list_spot_account_book(
            *args, **kwargs
        )
    ...
    def list_trades(self, *args, **kwargs) -> list[Trade]:
        ...
        """
        api_response = self.spot_api_instance.list_trades(
            *args, **kwargs
        )
        trades = list()
        for data in api_response.get() if kwargs.get("async_req") else api_response:
    ...
    def order_book(self, *args, **kwargs) -> OrderBook:
        ...
        """
        # List all spot accounts
        api_response = self.spot_api_instance.list_order_book(
            *args, **kwargs
        )
    ...
    def list_all_open_orders(self, *args, **kwargs) -> list[OpenOrders]:
        ...
        """
        api_response = self.spot_api_instance.list_all_open_orders(
            *args, **kwargs
        )
    ...
    def list_candlesticks(self, *args, **kwargs) -> list[Candlestick]:
        ...
        """
        api_response = self.spot_api_instance.list_candlesticks(
            *args, **kwargs
        )
